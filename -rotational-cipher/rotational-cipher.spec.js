...
describe('Rotational cipher', () => {
  ...
  test('rotate a by 0, same output as input', () => {
    const expected = 'b';
    const actual = RotationalCipher.rotate('b', 0);
  ...
  test('rotate a by 0, same output as input', () => {
    const expected = 'ab';
    const actual = RotationalCipher.rotate('ab', 0);
  ...
  test('rotate a by 1', () => {
    const expected = 'c';
    const actual = RotationalCipher.rotate('b', 1);
  ...
  test('rotate n by 13 with wrap around alphabet', () => {
    ...
    const actual = RotationalCipher.rotate('nopqr', 13);
  ...
  test('rotate n by 13 with wrap around alphabet', () => {
    ...
    const actual = RotationalCipher.rotate('n o p', 13);
